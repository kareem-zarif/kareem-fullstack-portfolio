    ...
    public PortfolioAppShellDefinition Get()
    {
        var definition = new PortfolioAppShellDefinition(
            ...
            routes: new List<PortfolioRouteDefinition>
            {
                ...
                new(PortfolioRouteType.Skills, "/skills", PortfolioLayoutType.Public, false, null, true, true, 5),
                new(PortfolioRouteType.Contact, "/contact", PortfolioLayoutType.Public, false, null, true, true, 6),
