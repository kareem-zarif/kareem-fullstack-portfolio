...
public static class kareem_fullstack_portfolioEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE kareem_fullstack_portfolioModuleExtensionConfigurator CLASS (in the Domain.Shared project)
