...
public class kareem_fullstack_portfolioDbContext :
    AbpDbContext<kareem_fullstack_portfolioDbContext>,
    IIdentityDbContext
{
    ...
    public kareem_fullstack_portfolioDbContext(DbContextOptions<kareem_fullstack_portfolioDbContext> options)
        : base(options)
    {
