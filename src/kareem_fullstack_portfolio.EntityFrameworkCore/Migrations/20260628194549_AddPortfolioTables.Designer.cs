...
namespace kareem_fullstack_portfolio.Migrations
{
    ...
    [Migration("20260628194549_AddPortfolioTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("kareem_fullstack_portfolio.ContactMessages.PortfolioContactMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("IsArchived", "IsRead", "CreationTime");

                    b.ToTable("AppPortfolioContactMessages", (string)null);
                });

            modelBuilder.Entity("kareem_fullstack_portfolio.Experience.PortfolioExperience", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("IsPrimaryProfessionalExperience")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("AppPortfolioExperiences", (string)null);
                });

            modelBuilder.Entity("kareem_fullstack_portfolio.Experience.PortfolioExperienceHighlight", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("PortfolioExperienceId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PortfolioExperienceId", "Text")
                        .IsUnique();

                    b.ToTable("AppPortfolioExperienceHighlights", (string)null);
                });

            modelBuilder.Entity("kareem_fullstack_portfolio.Projects.PortfolioProject", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppPortfolioProjects", (string)null);
                });

            modelBuilder.Entity("kareem_fullstack_portfolio.Projects.PortfolioProjectTechnology", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppPortfolioProjectTechnologies", (string)null);
                });

            modelBuilder.Entity("kareem_fullstack_portfolio.SiteSettings.PortfolioSiteSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppPortfolioSiteSettings", (string)null);
                });

            modelBuilder.Entity("kareem_fullstack_portfolio.Skills.PortfolioSkill", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("Category", "Name", "IsDeleted")
                        .IsUnique();

                    b.HasIndex("IsActive", "Category", "DisplayOrder");

                    b.ToTable("AppPortfolioSkills", (string)null);
                });
            ...
            modelBuilder.Entity("kareem_fullstack_portfolio.Experience.PortfolioExperienceHighlight", b =>
                {
                    b.HasOne("kareem_fullstack_portfolio.Experience.PortfolioExperience", null)
                        .WithMany("Highlights")
            ...
            modelBuilder.Entity("kareem_fullstack_portfolio.Projects.PortfolioProjectTechnology", b =>
                {
                    b.HasOne("kareem_fullstack_portfolio.Projects.PortfolioProject", null)
                        .WithMany("TechStack")
