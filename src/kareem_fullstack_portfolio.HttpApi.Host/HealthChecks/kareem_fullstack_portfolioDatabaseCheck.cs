...
namespace kareem_fullstack_portfolio.HealthChecks;

public class kareem_fullstack_portfolioDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public kareem_fullstack_portfolioDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
