...
using kareem_fullstack_portfolio.MultiTenancy;
using kareem_fullstack_portfolio.HealthChecks;
...
[DependsOn(
    typeof(kareem_fullstack_portfolioHttpApiModule),
...
public class kareem_fullstack_portfolioHttpApiHostModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        PreConfigure<OpenIddictBuilder>(builder =>
        {
            ...
            {
                options.AddAudiences("kareem_fullstack_portfolio");
    ...
    private void ConfigureVirtualFileSystem(ServiceConfigurationContext context)
    {
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            ...
            {
                options.FileSets.ReplaceEmbeddedByPhysical<kareem_fullstack_portfolioDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}kareem_fullstack_portfolio.Domain.Shared"));
                options.FileSets.ReplaceEmbeddedByPhysical<kareem_fullstack_portfolioDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}kareem_fullstack_portfolio.Domain"));
                options.FileSets.ReplaceEmbeddedByPhysical<kareem_fullstack_portfolioApplicationContractsModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}kareem_fullstack_portfolio.Application.Contracts"));
                options.FileSets.ReplaceEmbeddedByPhysical<kareem_fullstack_portfolioApplicationModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}kareem_fullstack_portfolio.Application"));
            });
        }
    }
    ...
    private void ConfigureConventionalControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(kareem_fullstack_portfolioApplicationModule).Assembly);
        });
    }
    ...
    private static void ConfigureSwagger(ServiceConfigurationContext context, IConfiguration configuration)
    {
        context.Services.AddAbpSwaggerGenWithOidc(
            ...
            ["kareem_fullstack_portfolio"],
            [AbpSwaggerOidcFlows.AuthorizationCode],
            null,
            options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "kareem_fullstack_portfolio API", Version = "v1" });
    ...
    {
        context.Services.Addkareem_fullstack_portfolioHealthChecks();
    }
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "kareem_fullstack_portfolio API");
